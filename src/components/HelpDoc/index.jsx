...
avoid.
                ...
                <p className="c12"><span className="c2 c1">As shown in the documentation we have 3 types of instructions, we cover the most important and most used ones :</span>
                </p>
                <ul className="c7 lst-kix_xdeeteg9a996-0 start">
                    <li className="c0 c20 li-bullet-0"><span
                        className="c1">Zero operands instructions, which are: </span><span
                        className="c6 c1 c4">RET, PUSHA, POPA</span></li>
                </ul>
                <ul className="c7 lst-kix_xdeeteg9a996-1 start">
                    <li className="c9 li-bullet-0"><span className="c1 c4">RET:</span><span className="c3 c1">This instruction is used to return control from a subroutine to the calling routine. It pops the top value from the stack and sets the program counter to that value, effectively jumping back to the instruction that called the subroutine.</span>
                    </li>
                    <li className="c9 li-bullet-0"><span className="c1 c4">PUSHA:</span><span className="c3 c1">This instruction is used to push the value of the main 8 registers onto the stack</span>
                    </li>
                    <li className="c9 li-bullet-0"><span className="c1 c4">POPA:</span><span className="c3 c1">This instruction is used to pop values from the &nbsp;stack &nbsp;and store them in the main 8 registers .</span>
                    </li>
                </ul>
                ...
                <p className="c12"><span className="c2 c1">The result of those two operations is stored in the ACC register.</span>
                </p>
                <p className="c5"><span className="c6 c1 c4"></span></p>
                <p className="c12"><span className="c2 c1">Then let&rsquo;s speak about operands:</span></p>
                <p className="c12"><span className="c2 c1">In our language there are two types of operands registers and numbers, numbers can be representing addresses or only immediate values, let&rsquo;s begin with the simplest:</span>
                </p>
                ...
                <p className="c0"><span className="c2 c1">&bull; 2 used in the based and Indexed addressing modes: BR, IDR.</span>
                </p>
                ...
                <ul className="c7 lst-kix_ly2ccm6d49ig-1 start">
                    <li className="c9 li-bullet-0"><span
                        className="c1">Direct mode: you just have to add an </span><span
                ...
                <p className="c12 c15"><span className="c1">Ps: You can perform an inverted addressing by writing negative addresses, like </span><span
                ...
                <ul className="c7 lst-kix_ly2ccm6d49ig-1">
                    <li className="c9 li-bullet-0"><span
                        className="c1">Indirect mode: to keep it simple for you, just add another </span><span
                ...
                <p className="c10 c19"><span className="c2 c1"></span></p>
                <p className="c10 c19"><span className="c2 c1"></span></p>
                <p className="c12"><span className="c2 c1">Some errors you can do while writing calM&rsquo;s assembly code:</span>
                </p>
