...
<input type="text" name="text" className="input" />
  ...
  const Questionsswiper = () => {
    ...
    return (
      <Question1  num={data.num}  instr1={data.instr1}  instr2={data.instr2}  instr3={data.instr3}  instr4={data.instr4}  instr5={data.instr5}  instr6={data.instr6}  instr7={data.instr7}  instr8={data.instr8} />
    )
